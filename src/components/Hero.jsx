...
function Hero() {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 px-4 py-16 sm:px-6 sm:py-20 text-slate-100" id="hero">
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col gap-8 lg:flex-row lg:items-center">
          <div className="flex-1 space-y-6">
            <p className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 text-sm text-emerald-100 ring-1 ring-emerald-500/30 opacity-0 animate-fadeIn animate-delay-100">
            ...
            {/* Stats */}
            <div className="flex flex-col sm:flex-row flex-wrap gap-6 sm:gap-8 pt-4 opacity-0 animate-fadeInUp animate-delay-500">
          ...
          <div className="flex-1 space-y-4 opacity-0 animate-scaleIn animate-delay-400">
            <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 to-white/[0.02] p-4 sm:p-6 shadow-2xl shadow-emerald-500/10 backdrop-blur transition-all duration-300 hover:border-emerald-500/30 hover:shadow-emerald-500/20">
              ...
              <div className="space-y-3 text-sm text-slate-200">
                <div className="rounded-2xl border border-white/10 bg-slate-900/60 p-3 sm:p-4 transition-all duration-200 hover:border-emerald-500/40 hover:bg-slate-900/80 hover:-translate-y-1 hover:shadow-lg hover:shadow-emerald-500/10">
      ...
      {/* Features Section */}
      <section ref={featuresRef} className="bg-slate-950 px-4 sm:px-6 py-16 sm:py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-0">
          <div className={`mb-8 sm:mb-12 text-center transition-all duration-500 ${featuresVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            <div className={`group rounded-2xl border border-white/10 bg-gradient-to-br from-emerald-500/5 to-transparent p-4 sm:p-6 transition-all duration-300 hover:border-emerald-500/40 hover:shadow-lg hover:shadow-emerald-500/10 hover:-translate-y-1 ${featuresVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '100ms' }}>
            ...
            <div className={`group rounded-2xl border border-white/10 bg-gradient-to-br from-cyan-500/5 to-transparent p-4 sm:p-6 transition-all duration-300 hover:border-cyan-500/40 hover:shadow-lg hover:shadow-cyan-500/10 hover:-translate-y-1 ${featuresVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '150ms' }}>
            ...
            <div className={`group rounded-2xl border border-white/10 bg-gradient-to-br from-blue-500/5 to-transparent p-4 sm:p-6 transition-all duration-300 hover:border-blue-500/40 hover:shadow-lg hover:shadow-blue-500/10 hover:-translate-y-1 ${featuresVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '200ms' }}>
            ...
            <div className={`group rounded-2xl border border-white/10 bg-gradient-to-br from-purple-500/5 to-transparent p-4 sm:p-6 transition-all duration-300 hover:border-purple-500/40 hover:shadow-lg hover:shadow-purple-500/10 hover:-translate-y-1 ${featuresVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '250ms' }}>
            ...
            <div className={`group rounded-2xl border border-white/10 bg-gradient-to-br from-pink-500/5 to-transparent p-4 sm:p-6 transition-all duration-300 hover:border-pink-500/40 hover:shadow-lg hover:shadow-pink-500/10 hover:-translate-y-1 ${featuresVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '300ms' }}>
            ...
            <div className={`group rounded-2xl border border-white/10 bg-gradient-to-br from-orange-500/5 to-transparent p-4 sm:p-6 transition-all duration-300 hover:border-orange-500/40 hover:shadow-lg hover:shadow-orange-500/10 hover:-translate-y-1 ${featuresVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '350ms' }}>
      ...
      <section ref={testimonialsRef} className="bg-slate-900/50 px-4 sm:px-6 py-16 sm:py-20">
        <div className="mx-auto max-w-6xl">
          <div className={`mb-8 sm:mb-12 text-center transition-all duration-500 ${testimonialsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            <div className={`rounded-2xl border border-white/10 bg-slate-900/60 p-4 sm:p-6 transition-all duration-300 hover:border-white/20 hover:-translate-y-1 hover:shadow-lg ${testimonialsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '100ms' }}>
      ...
      {/* CTA Section */}
      <section ref={ctaRef} className="bg-slate-950 px-4 sm:px-6 py-16 sm:py-20">
